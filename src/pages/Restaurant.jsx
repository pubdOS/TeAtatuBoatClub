        ...
        <div className="section grid gap-8 md:grid-cols-2">
          <AnimatedSection className="h-full">
            <div className="card h-full p-7">
              <h2 className="text-xl font-semibold" data-cms="Restaurant - Hours - Club Rooms Heading">
                {c.restaurant_clubrooms_heading}
              </h2>
              <ul data-cms-repeater="Restaurant - Hours - Club Rooms List" data-cms-shape="list" data-cms-min="1" data-cms-max="7" data-cms-overflow="wrap" className="mt-4 divide-y divide-navy/5">
          ...
          <AnimatedSection delay={120} className="h-full">
            <div className="card h-full p-7">
              <h2 className="text-xl font-semibold" data-cms="Restaurant - Hours - Kitchen Heading">
                {c.restaurant_kitchen_heading}
              </h2>
              <p className="mt-1 text-sm text-navy/60" data-cms="Restaurant - Hours - Kitchen Sub">{c.restaurant_kitchen_sub}</p>
              <ul data-cms-repeater="Restaurant - Hours - Kitchen List" data-cms-shape="list" data-cms-min="1" data-cms-max="7" data-cms-overflow="wrap" className="mt-4 divide-y divide-navy/5">
